...
\node[canvas is zy plane at x=0] (temp) at (-3,0,0) {\includegraphics[width=8cm,height=8cm]{605_cropped.jpg}};
...
\pic[shift={ (0,0,0) }] at (ccr_b1-east) 
    {Box={
        ...
        width=1,
        depth=32,
        xlabelsize=20, zlabelsize=20, xlabelshift={(0, 0)}, zlabelshift={(0, 0)}, 
        }
    };
...
\pic[shift={(0,0,0)}] at (ccr_res_b6-east) 
    {Box={
        ...
        width=5.0,
        depth=16,
        xlabelsize=20, zlabelsize=20, xlabelshift={(0, 0)}, zlabelshift={(0, 0)}, xlabelangle=45, 
        }
    };
...
\coordinate (end_of_axis) at ($(pic cs:soft1-east) + (2,0,0)$);
\node[canvas is zy plane at x=38] (output) at (end_of_axis) {\includegraphics[width=8cm,height=8cm]{mask_rgb.jpg}};
